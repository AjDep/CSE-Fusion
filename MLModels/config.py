...
FUSION_BUY_SCORE_THRESHOLD = float(os.getenv('FUSION_BUY_SCORE_THRESHOLD', 0.35))
FUSION_STRONG_BUY_SCORE_THRESHOLD = float(os.getenv('FUSION_STRONG_BUY_SCORE_THRESHOLD', 0.90))
FUSION_SELL_SCORE_THRESHOLD = float(os.getenv('FUSION_SELL_SCORE_THRESHOLD', -0.55))
